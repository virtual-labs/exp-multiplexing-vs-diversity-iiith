...
## Comparison Between Spatial Multiplexing and Spatial Diversity
...
| Use of DoF | Used for parallel streams | Used for creating diverse paths |
| Capacity | High capacity | Moderate capacity |
| BER Performance | Higher BER (at same SNR) | Lower BER |
| SNR | Low/moderate, same as  SISO | Improved by comibining |
