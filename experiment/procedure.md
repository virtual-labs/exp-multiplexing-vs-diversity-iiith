To analyze the tradeoff between spatial multiplexing and diversity gain in a Multiple Input Multiple Output (MIMO) system, please follow the following steps :
